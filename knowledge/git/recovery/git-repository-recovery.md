...
description: Procedimentos de recuperação, ressincronização e reconstrução de repositórios Git e submodules em estados inconsistentes ou corrompidos.
---
...
- [Sub Modules Life Cycle](/operations/git-submodule-lifecycle.md)
- [Sub Modules Clean Up](/knowledge/git/submodules/cleanup-submodules.md)
